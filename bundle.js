...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n/** Maijor elements**/\nvar elements = exports.elements = {\n    content: document.querySelector('.content'),\n    brands: document.querySelector('.brands'),\n    jumbotron: document.querySelector('.jumbotron'),\n    searchPage: document.querySelector('.after-search'),\n    searchInput: document.getElementById('search__input'),\n    searchButton: document.getElementById('search__button'),\n    searchResults: document.querySelector('.results'),\n    searchResultsList: document.querySelector('.results__list'),\n    searchResPages: document.querySelector('.results__btn'),\n    searchResSortBtn: document.querySelector('.results__sort-btn'),\n    searchNotFound: document.querySelector('.item__notfound'),\n    item: document.querySelector('.view-item')\n};\n\nvar elementStrings = exports.elementStrings = {\n    loader: 'loader',\n    itemBrand: 'state.search.result.brand',\n    itemTitle: 'state.search.result.title',\n    itemArticle: 'state.search.result.article',\n    itemPrice: 'state.search.result.price',\n    itemUrl: 'state.search.result.url',\n    itemImgUrl: 'state.search.result.img_url'\n};\n\n/** ICON LOADER **/\n\n// 1. Function which create loader svg icon\n// export const renderLoader = parent => {\n//     const loader = `\n//         <div class=\"${elementStrings.loader}\">\n//             <svg>\n//                 <use href=\"img/sprite.svg#icon-spinner11\"></use>\n//             </svg>\n//         </div>\n//     `;\n//     parent.insertAdjacentHTML('afterbegin', loader);\n// }\n\n// // 1. Function which remove loader svg icon\n// export const clearLoader = () => {\n//     const loader = document.querySelector(`.${elementStrings.loader}`);\n//     if (loader) {\n//         loader.parentElement.removeChild(loader);\n//     }\n// }\n\n//# sourceURL=webpack:///./src/js/view/base.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderItem = exports.clearItem = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar clearItem = exports.clearItem = function clearItem() {\n    _base.elements.item.innerHTML = \"\";\n};\nvar countDiscount = function countDiscount(new_pr, old_pr) {\n    var discount = Math.ceil(100 - new_pr / old_pr * 100);\n    return discount;\n};\n\nvar renderBrandDescription = function renderBrandDescription(br) {\n    var brandsDescription = void 0;\n    if (br === \"befree\") {\n        brandsDescription = \"Befree — сеть мультибрендовых магазинов женской и мужской одежды.\";\n    } else if (br === \"ostin\") {\n        brandsDescription = \"Ostin - международный бренд, предлагающий широкий выбор одежды и аксессуаров в стилеcasual для женщин, мужчин и детей. По состоянию на 2016 год осуществляет свою деятельность в России, Белоруссии, Казахстане, Китае и Украине.\";\n    } else if (br === \"colins\") {\n        brandsDescription = \"Colin`s — популярная турецкая марка одежды и аксессуаров. Владельцем розничной сети готовой одежды является холдинг Eroğlu, изначально небольшое семейное предприятие по пошиву одежды, выросшее в одну из самых крупных и успешных бизнес-организаций Турции.\";\n    } else {\n        brandsDescription = \"NON\";\n    }\n    return brandsDescription;\n};\n\nvar loyalty = function loyalty(br) {\n    var brandLoyaltyHfef = void 0;\n    if (br === \"befree\") {\n        brandLoyaltyHfef = \"https://www.befree.ru/reward/guest/registration/\";\n    } else if (br === \"ostin\") {\n        brandLoyaltyHfef = \"https://ostin.com/ru/ru/pages/club_ostin/#hello\";\n    } else if (br === \"colins\") {\n        brandLoyaltyHfef = \"http://www.colins.ru/t/Programofloyalty\";\n    } else {\n        brandLoyaltyHfef = \"NON\";\n    }\n    return brandLoyaltyHfef;\n};\nvar renderItem = exports.renderItem = function renderItem(item) {\n    var markup = \"\\n        <div class=\\\"view\\\">\\n            <figure class=\\\"view__fig\\\">\\n                <img src=\\\"\" + item.img_url + \"\\\" alt=\\\"\" + item.title + \"\\\" class=\\\"view__img\\\">\\n            </figure>\\n        </div>\\n        <div class=\\\"item\\\">\\n            <div class=\\\"item__header\\\">\\n                <h2 class=\\\"item__brand\\\">\" + item.brand + \"</h2>\\n                <h1 class=\\\"item__title\\\">\" + item.title + \"</h1>\\n                <p class=\\\"item__price\\\">\\n                <span class=\\\"item__price-value\\\">\" + item.new_price + \"</span>&nbsp;<span class=\\\"item__price-cur\\\">&#8381;</span>\\n                <span class=\\\"item__discount\\\"> -\" + countDiscount(item.new_price, item.old_price) + \"%</span></p>\\n            </div>\\n            <div class=\\\"item__content\\\">\\n                <p class=\\\"item__description\\\">\" + item.description + \"</p>\\n                <a href=\\\"\" + item.url + \"\\\" class=\\\"item__url\\\"> \\u041F\\u0435\\u0440\\u0435\\u0439\\u0442\\u0438 \\u043D\\u0430 \\u0441\\u0430\\u0439\\u0442 &rarr;</a>\\n            </div>\\n            <div class=\\\"item__description\\\">\" + renderBrandDescription(item.brand) + \"</div>\\n            <a href=\\\"\" + loyalty(item.brand) + \"\\\" class=\\\"item__url\\\"> \\u041F\\u0440\\u043E\\u0433\\u0440\\u0430\\u043C\\u043C\\u0430 \\u043B\\u043E\\u044F\\u043B\\u044C\\u043D\\u043E\\u0441\\u0442\\u0438 \\u0432\\u0435\\u043D\\u0434\\u043E\\u0440\\u0430 &rarr;</a>\\n    </div>\\n    \";\n\n    _base.elements.item.insertAdjacentHTML('beforeend', markup);\n};\n\n//# sourceURL=webpack:///./src/js/view/itemView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderResults = exports.renderSortButtons = exports.noItem = exports.clearPage404 = exports.clearResult = exports.clearInput = exports.clearBrands = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\n// 1. Recive '.search__input' value\nvar getInput = exports.getInput = function getInput() {\n    return _base.elements.searchInput.value;\n};\n\n// export const creatRenderFrame = () => {\n//     const markup = `\n//         <div class=\"results\">\n//             <ul class=\"results__list\">\n//             </ul>\n//         </div>\n//         <div class=\"results__btn\"></div>\n//         <div class=\"view-item\"></div>\n//     `;\n//     elements.content.innerHTML = markup;\n// }\nvar clearBrands = exports.clearBrands = function clearBrands() {\n    _base.elements.brands.parentElement.removeChild(_base.elements.brands);\n    _base.elements.jumbotron.parentElement.removeChild(_base.elements.jumbotron);\n};\n\n// 2. Remove '.search__input' value\nvar clearInput = exports.clearInput = function clearInput() {\n    _base.elements.searchInput.value = '';\n};\n// 3. Clear results\nvar clearResult = exports.clearResult = function clearResult() {\n    _base.elements.searchResultsList.innerHTML = \"\";\n    _base.elements.searchResPages.innerHTML = \"\";\n};\nvar clearPage404 = exports.clearPage404 = function clearPage404() {\n    document.querySelector('.item__notfound').parentElement.removeChild(document.querySelector('.item__notfound'));\n};\n\nvar noItem = exports.noItem = function noItem() {\n    var markup = '\\n        <p class=\"item__notfound\">\\u0420\\u0435\\u0437\\u0443\\u043B\\u044C\\u0442\\u0430\\u0442 \\u043F\\u043E \\u0432\\u0430\\u0448\\u0435\\u043C\\u0443 \\u0437\\u0430\\u043F\\u0440\\u043E\\u0441\\u0443 \\u043D\\u0435 \\u043D\\u0430\\u0439\\u0434\\u0435\\u043D. \\u041F\\u043E\\u043F\\u0440\\u043E\\u0431\\u0443\\u0439\\u0442\\u0435 \\u0438\\u0437\\u043C\\u0435\\u043D\\u0438\\u0442\\u044C \\u0437\\u0430\\u043F\\u0440\\u043E\\u0441.\\n        </p>    \\n    ';\n    _base.elements.searchPage.insertAdjacentHTML('afterbegin', markup);\n};\n\nvar limitItemTitle = function limitItemTitle(title) {\n    var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 12;\n\n    var newTitle = [];\n    if (title.length > limit) {\n        title.split(' ').reduce(function (acc, cur) {\n            if (acc + cur.length <= limit) {\n                newTitle.push(cur);\n            }\n            return acc + cur.length;\n        }, 0);\n        return newTitle.join(' ') + ' ...';\n    }\n    return title;\n};\n// Create sort button \nvar renderSortButtons = exports.renderSortButtons = function renderSortButtons() {}\n// const markup = `\n//     <button class=\"btn-sort btn-sort--inc\">\n//         <svg class=\"item__icon-social\">\n//             <use xlink:href=\"img/sprite.svg#icon-sort-amount-asc\"></use>\n//         </svg>\n//     </button>\n//     <button class=\"btn-sort btn-sort--dec\">\n//         <svg class=\"item__icon-social\">\n//             <use xlink:href=\"img/sprite.svg#icon-sort-amount-desc\"></use>\n//         </svg>\n//     </button>\n// `\n// elements.searchResSortBtn.insertAdjacentHTML('afterbegin', markup);\n\n\n// Создать кнопку\n;var createButton = function createButton(page, type) {\n    return '\\n    <button class=\"btn-inline results__btn--' + type + '\" data-goto=' + (type === 'prev' ? page - 1 : page + 1) + '>\\n        <svg class=\"results__icon\">\\n            <use href=\"img/sprite.svg#icon-triangle-' + (type === 'prev' ? 'left' : 'right') + '\"></use>\\n        </svg>\\n    </button>\\n';\n};\nvar renderButton = function renderButton(page, numResult, resPerPage) {\n    // pages = 80 / 8 = 10 \n    var pages = Math.ceil(numResult / resPerPage);\n\n    var button = void 0;\n    // 1. Номер страницы = 1; страниц больше 1\n    if (page === 1 && pages > 1) {\n        button = createButton(page, 'next');\n        //  2. Номер страницы меньше числа страниц\n    } else if (page < pages) {\n        button = '\\n        ' + createButton(page, 'next') + '\\n        ' + createButton(page, 'prev') + '\\n        ';\n    } else if (page === pages && pages > 1) {\n        button = createButton(page, 'prev');\n    } else {\n        button = \"\";\n    }\n    _base.elements.searchResPages.insertAdjacentHTML('afterbegin', button);\n};\n// 4. Render item\nvar renderItem = function renderItem(item) {\n    // Create markup for item\n    var markup = '\\n        <li>\\n            <a href=\"#' + item.article + '\" class=\"results__link\">\\n                <figure class=\"results__fig\">\\n                    <img src=\"' + item.img_url + '\" alt=\"' + item.title + '\" class=\"results__img\">\\n                </figure>\\n                <div class=\"results__data\">\\n                    <div class=\"results__info\">\\n                        <h4 class=\"results__title\">' + limitItemTitle(item.title) + '</h4>\\n                        <p class=\"results__brand\">' + item.brand + '</p>\\n                    </div>\\n                    \\n                    <div class=\"results__price\">\\n                        <p>' + item.new_price + '<span>&#8381</span></p>\\n                    </div>\\n                </div>\\n                \\n            </a>\\n        </li>\\n    ';\n    // Insert item after searchResultList\n    _base.elements.searchResultsList.insertAdjacentHTML('beforeend', markup);\n};\n\n// 5. Render function\nvar renderResults = exports.renderResults = function renderResults(items) {\n    var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n    var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 9;\n\n    var start = (page - 1) * resPerPage;\n    var end = page * resPerPage;\n\n    items.slice(start, end).forEach(renderItem);\n    renderButton(page, items.length, resPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/view/searchView.js?");
